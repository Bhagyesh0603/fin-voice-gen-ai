...
import { Wallet, Eye, EyeOff, Mail, Lock, ArrowLeft, Shield, Zap, MessageCircle } from "lucide-react"
        ...
        <Card className="shadow-xl border-0 bg-card/80 backdrop-blur-sm">
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              ...
              <CardDescription className="text-base mt-2">
                Sign in to your FinVoice account to continue managing your finances
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full h-12 text-base bg-transparent" onClick={handleGoogleLogin}>
              ...
              <Button variant="outline" className="w-full h-12 text-base bg-transparent" onClick={handleAppleLogin}>
